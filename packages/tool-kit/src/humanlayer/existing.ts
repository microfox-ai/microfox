...
// THe idea is the frontend will send a message of confirmation or denial of the tool execution
// and the backend will execute the tool if the confirmation is yes, and delete the last message in thequeue when beingg  processed.
    ...
    parts.map(async part => {
      ...
      if (toolInvocation.result === APPROVAL.YES) {
        ...
        if (
          ...
          console.log('toolName not found in executeFunctions', toolName);
          return part;
        }
