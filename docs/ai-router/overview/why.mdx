---
title: 'The Problem: Why AI Router Exists'
...
Ai-Router is a powerful, composable router framework for building structured, multi-agent AI applications. Heavily inspired by the simplicity and power of [Express.js](https://expressjs.com/) & Agent as Tool approach of Google's Agent Development kit [Adk](https://google.github.io/adk-docs/),
...
- **Vercel AI SDK integration**: Native streaming support
- **Frontend-friendly**: Designed for `useChat` and similar patterns
