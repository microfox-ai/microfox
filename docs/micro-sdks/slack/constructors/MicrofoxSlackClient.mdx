---
title: 'MicrofoxSlackClient'
description: 'The main client for interacting with the Slack API.'
---

The `MicrofoxSlackClient` is a custom client designed to simplify common automation tasks by providing a set of minimal, easy-to-use functions that wrap the official `@microfox/slack/web-api`.
